...
<div class="font-sans ">
    ...
    <section class="py-32 bg-white" data-aos="fade-up" data-aos-delay="100">
        <div class="container mx-auto px-6 text-center">
            <h2 class="text-5xl font-black mb-4 tracking-tight ">Mengapa Bergabung?</h2>
            <p class="text-slate-400 text-xl mb-24 font-medium ">Ratusan mitra sudah merasakan manfaatnya</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="p-10 rounded-[40px] bg-white border border-slate-50 shadow-[0_15px_50px_rgba(0,0,0,0.03)] text-left group hover:bg-[#0095FF] transition duration-500">
                    <div class="w-16 h-16 bg-blue-50 rounded-2xl flex items-center justify-center text-[#0095FF] mb-8 group-hover:bg-white/20 group-hover:text-white transition ">
                        <i data-lucide="{{ $item['icon'] }}" class="w-8 h-8"></i>
                    </div>
                    <h3 class="text-xl font-black mb-4 group-hover:text-white ">{{ $item['title'] }}</h3>
                    <p class="text-slate-400 text-sm leading-relaxed group-hover:text-white/80 ">{{ $item['desc'] }}</p>
                </div>
                @endforeach
            </div>
        </div>
    ...
    <section class="py-32 bg-[#F8FAFC]" data-aos="fade-up" data-aos-delay="100">
        <div class="container mx-auto px-6 text-center">
            <h2 class="text-5xl font-black mb-4 tracking-tighter ">Cara Bergabung</h2>
            <p class="text-slate-400 text-xl mb-24 font-medium ">Mudah dan cepat, hanya 3 langkah</p>
            ...
            <div class="relative max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-center gap-12 mb-24">
                ...
                <div class="relative z-10 flex flex-col items-center max-w-[250px]">
                    <div class="w-24 h-24 bg-[#0095FF] text-white rounded-full flex items-center justify-center text-3xl font-black shadow-xl shadow-blue-200 mb-8 ">
                        {{ $step['num'] }}
                    </div>
                    <h4 class="text-xl font-black mb-4 ">{{ $step['title'] }}</h4>
    ...
    <section class="py-32 bg-white" data-aos="fade-up" data-aos-delay="100">
        <div class="container mx-auto px-6 text-center">
            <h2 class="text-5xl font-black mb-24 ">Kata Mitra Kami</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-6xl mx-auto mb-32">
                ...
                <div class="p-12 rounded-[50px] bg-white border border-slate-50 shadow-[0_20px_60px_rgba(0,0,0,0.05)] text-left ">
                    <div class="flex items-center gap-6 mb-8">
                        <img src="{{ $testi['img'] }}" class="w-20 h-20 rounded-full object-cover border-4 border-white shadow-xl">
                        <div>
                            <h4 class="text-xl font-black ">{{ $testi['name'] }}</h4>
                    ...
                    <p class="text-slate-500 text-lg leading-relaxed ">{{ $testi['quote'] }}</p>
                </div>
                @endforeach
            </div>
            
            <div class="bg-[#0095FF] rounded-[60px] p-20 text-white relative overflow-hidden  shadow-2xl">
