...
<div class="bg-[#F8FAFC] min-h-screen pt-32 pb-20 font-sans italic" 
    ...
    <div class="container mx-auto px-6">
        <div class="max-w-4xl mx-auto mb-8">
            <button @click="step > 2 ? step-- : window.location.href='{{ route('home') }}'" 
        ...
        <div class="space-y-4">
            ...
            <div class="sticky top-32">
                <div class="bg-white p-10 rounded-[50px] border border-slate-100 shadow-2xl shadow-blue-100 italic">
                    ...
                    <h2 class="text-4xl font-black text-[#0095FF] mb-12 uppercase">Premium</h2>
                    ...
                    <button @click="handleNext()" 
                            :disabled="(step === 2 && !kos) || (step === 3 && !catering) || (step === 4 && !laundry)"
                            ...
                            :class="((step === 2 && !kos) || (step === 3 && !catering) || (step === 4 && !laundry)) ? 'bg-slate-200' : 'bg-[#0095FF] shadow-blue-200'">
