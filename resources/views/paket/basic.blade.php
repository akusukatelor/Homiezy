...
<div class="bg-[#F8FAFC] min-h-screen pt-32 pb-20 font-sans italic" 
    ...
    },
    {
      ...
      handleNext() {
            if (this.step === 2) {
                if (this.kos) {
                    this.step = 5; // Loncat ke Review
                }
            } else if (this.step === 5) {
                this.showSuccessModal = true; // Munculkan Modal
            }
        },
   ...
   <button @click="step === 5 ? step = 2 : (step > 2 ? step-- : window.location.href='{{ route('home') }}')" 
        ...
        <div class="space-y-4">
            ...
            <div class="sticky top-32">
                <div class="bg-white p-10 rounded-[50px] border border-slate-100 shadow-2xl shadow-blue-100 italic">
                 ...
                 <button @click="handleNext()" :disabled="(step === 2 && !kos)" 
                            ...
                            :class="(!kos && step === 2) ? 'bg-slate-200' : 'bg-[#0095FF] shadow-blue-200'">
                        <span x-text="step === 5 ? 'Konfirmasi & Bayar' : 'Lanjut ke Bayar'"></span>
                    </button>
    ...
    <div x-show="showSuccessModal" 
        ...
        <div class="bg-white p-12 rounded-[56px] max-w-lg w-full text-center shadow-2xl transform transition-all"
            ...
            <p class="text-slate-500 font-bold mb-10 leading-relaxed italic text-sm text-center">
                Terima kasih! Pesanan kamu sudah kami terima. Tim kami akan segera menghubungi kamu melalui WhatsApp.
            </p>
